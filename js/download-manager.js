...
(function () {
  ...
  async function downloadMusic() {
    ...
    if (!audio?.src) return setStatus('download-music-status', 'Toque uma música');
    const track = {
      url: audio.src,
    ...
    await queueDownload(makeMusicItem(track), 'download-music-status');
  }
  ...
  async function clearAllDownloads() {
    ...
    setStatus('download-music-status', '');
  }
